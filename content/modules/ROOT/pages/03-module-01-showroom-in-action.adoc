...
* Identify the key components of a Showroom content repository
...
* Two delivery models exist: full RHDP deployment (split-pane with terminals) and GitHub Pages (standalone content site)
